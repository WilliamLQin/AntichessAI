//
// Created by William on 2022-10-10.
//
// This file is the API header for other scripts to include
// chess.cpp includes chess.h, which defines several global variables so it cannot be included in more than
// one script or else there will be linkage errors

// and for some reason??? I cannot move the globals out of chess.h into chess.cpp
// I cannot even make a separate .h file that has the globals
// it HAS to be in chess.h for some reason

#ifndef ANTICHESSAI_CPPCHESS_H
#define ANTICHESSAI_CPPCHESS_H
